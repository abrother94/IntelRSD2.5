 ...
 <edmx:Reference Uri="/redfish/v1/metadata/AccelerationFunction_v1.xml">
  ...
  <edmx:DataServices>
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Intel.Oem">
      ...
      <ComplexType Name="NetworkProtocol" BaseType="Intel.Oem.Resource">
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="KVMIP" Type="Intel.Oem.KVMIP">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="Intel RackScale extensions for additional Manger's Network Protocols support."/>
          <Annotation Term="OData.LongDescription" String="Intel RackScale extensions for NetworkProtocol. Provides HTML5 endpoint information on RFB over WebSocket connection."/>
        </Property>
      </ComplexType>

      <ComplexType Name="KVMIP">
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="URI" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="URI to access WebSocket Graphical Console."/>
          <Annotation Term="OData.LongDescription"
                      String="URI to access WebSocket Graphical Console."/>
        </Property>
        <Property Name="Protocol" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Graphical Console protocol name."/>
          <Annotation Term="OData.LongDescription" String="Graphical Console protocol name."/>
        </Property>
      ...
      <ComplexType Name="ComputerSystem" BaseType="Intel.Oem.Resource">
        ...
        <Property Name="ProcessorSockets" Type="Edm.Int64">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been Deprecated in favor of ProcessorCollection/Members@odata.count."/>
        </Property>
        <Property Name="MemorySockets" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This indicates number of memory sockets available in system"/>
          <Annotation Term="Redfish.Deprecated" String="This value has been Deprecated in favor of MemoryCollection/Members@odata.count."/>
        </Property>
      ...
      <ComplexType Name="Processor" BaseType="Intel.Oem.Resource">
        ...
        <Property Name="OnPackageMemory" Type="Collection(Intel.Oem.ProcessorMemory)">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a reference to the resources that this processor is associated with and shall reference a resource of type Endpoint."/>
          <Annotation Term="Redfish.Deprecated" String="This value has been Deprecated in favor of ProcessorMemory."/>
        </Property>
      ...
      <ComplexType Name="ProcessorMetrics">
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="Health" Type="Collection(Edm.String)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
      ...
      <ComplexType Name="FPGA">
        ...
        <Property Name="Type" Type="Intel.Oem.FpgaType" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of Type in Processor/FPGA."/>
        </Property>
        <Property Name="BitStreamVersion" Type="Edm.String">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of FirmwareVersion in Processor/FPGA."/>
        </Property>
        <Property Name="HSSIConfiguration" Type="Intel.Oem.HSSIConfig">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of HostInterface in Processor/FPGA resource."/>
        </Property>
        <Property Name="HSSISideband" Type="Intel.Oem.HSSISideband">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated."/>
        </Property>
        <Property Name="Model" Type="Intel.Oem.FpgaModel" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of Model in Processor."/>
        </Property>
        <Property Name="FwId" Type="Edm.String" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of FirmwareId in Processor/FPGA."/>
        </Property>
        <Property Name="FwManufacturer" Type="Edm.String" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of FirmwareManufacturer in Processor/FPGA."/>
        </Property>
        ...
        <Property Name="HostInterface" Type="Intel.Oem.FpgaInterface" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of HostInterface in Processor/FPGA."/>
        </Property>
        <Property Name="ExternalInterfaces" Type="Collection(Intel.Oem.FpgaInterface)" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of ExternalInterfaces in Processor/FPGA."/>
        </Property>
        ...
        <Property Name="PCIeVirtualFunctions" Type="Edm.Int64" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of PCIeVirtualFunctions in Processor/FPGA."/>
        </Property>
        <Property Name="ProgrammableFromHost" Type="Edm.Boolean">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of ProgrammableFromHost in Processor/FPGA."/>
        </Property>
        <Property Name="ReconfigurationSlots" Type="Edm.Int64">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of size of FpgaReconfigurationSlots array in Processor/FPGA."/>
        </Property>
        <Property Name="ReconfigurationSlotsDetails" Type="Collection(Intel.Oem.FpgaReconfigurationSlot)" Nullable="false">
          ...
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of FpgaReconfigurationSlots array in Processor/FPGA."/>
        </Property>
        <NavigationProperty Name="AccelerationFunctions" Type="AccelerationFunctionCollection.AccelerationFunctionCollection" ContainsTarget="true" Nullable="false">
          ...
          <Annotation Term="OData.AutoExpandReferences"/>
          <Annotation Term="Redfish.Deprecated" String="This value has been deprecated in favor of Processor/FPGA/AccelerationFunctions."/>
        </NavigationProperty>
      ...
      <ComplexType Name="LogEntry" BaseType="Intel.Oem.Resource">
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="RecordID" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="If EntryType is SEL, this shall be the ID of the SEL Record."/>
          <Annotation Term="OData.LongDescription"
                      String="If EntryType is SEL, this shall be the ID of the SEL Record. Otherwise this property shall be null or not present."/>
          <Annotation Term="Validation.Minimum" Int="0"/>
        </Property>
      </ComplexType>
