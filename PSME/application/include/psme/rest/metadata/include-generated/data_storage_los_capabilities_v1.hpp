...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="DataStorageLoSCapabilities.v1_2_0">
      <Annotation Term="Redfish.OwningEntity" String="SNIA"/>
      <Annotation Term="OData.Description" String="Add maximum recoverable capacity sources to DataStorageLoSCapabilities. This version was also created to force the regeneration of JSON Schema so that OData properties are marked as required, and integer properties are marked as integer rather than number."/>

      <EntityType Name="DataStorageLoSCapabilities" BaseType="DataStorageLoSCapabilities.v1_1_1.DataStorageLoSCapabilities">
        <Annotation Term="OData.Description" String="Describe data storage capabilities. Make SupportedLinesOfService be a containment NavigationProperty."/>
