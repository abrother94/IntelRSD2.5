  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="FileSystem.v1_0_0">
      ...
      <EntityType Name="FileSystem" BaseType="FileSystem.FileSystem">
        ...
        <Property Name="RemainingCapacity" Type="Capacity.Capacity">
          ...
          <Annotation Term="Redfish.Deprecated" String="This property is deprecated in favor of the Capacity property.  The RemainingCapacity can be computed from the values of that property, for each of the sub groups xxx: Data, MetaData, and Snapshot.  The RemainingCapacity is xxx/ProvisionedBytes - xxx/ConsumedBytes."/>
        </Property>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="FileSystem.v1_0_1">
      ...
      <EntityType Name="FileSystem" BaseType="FileSystem.v1_0_0.FileSystem">
        ...
        <Property Name="ImportedShares" Type="Collection(FileSystem.ImportedShare)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
