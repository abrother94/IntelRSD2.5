  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="IOPerformanceLoSCapabilities.v1_1_1">
      ...
      <EntityType Name="IOPerformanceLoSCapabilities" BaseType="IOPerformanceLoSCapabilities.v1_1_0.IOPerformanceLoSCapabilities">
        <Annotation Term="OData.Description" String="Use Redfish Location type, and change IOPerformanceLineOfService to EntityType.  Move enums to unversioned namespace. Change references to unversioned."/>
      </EntityType>
    </Schema>
