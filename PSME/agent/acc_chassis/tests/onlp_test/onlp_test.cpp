...
void TestClass1::SetUp() 
{
    ...
    while(ii !=0)
    {
	 ...
	 auto start = std::chrono::system_clock::now();
        ...
        {
            printf("Port present %d [%d] \r\n", i, sonlp.get_port_info_by_(i, acc_onlp_helper::Acc_Switch::Port_Present ));
	 ...
	 start = std::chrono::system_clock::now();	
        ...
        for(int i = 1; i <= psu_max; i++)	
        {
            ...
            printf("PSU present %d [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Psu_Present));    
            printf("PSU Vin %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Vin));    
            printf("PSU Vout %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Vout));    
            printf("PSU Iin %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Iin));    
            printf("PSU Iout %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Iout));    
            printf("PSU Pin %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Pin));    
            printf("PSU Pout %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Pout));    
            printf("PSU Psu_type %d       [%d] \r\n", i, sonlp.get_psu_info_by_(i, acc_onlp_helper::Acc_Switch::Psu_type));    
        ...
        auto& sonlp2 = acc_onlp_helper::Acc_Switch::get_instance();
	 ...
	 start = std::chrono::system_clock::now();			
        ...
        {
            printf("Thermal type %d [%d] \r\n", i, sonlp2.get_thermal_info_by_(i, acc_onlp_helper::Acc_Switch::Thermal_Type));    
        ...
        auto& sonlp3 = acc_onlp_helper::Acc_Switch::get_instance();
	 ...
	 start = std::chrono::system_clock::now();					
        ...
        {
            printf("fan type %d [%d] \r\n", i, sonlp3.get_fan_info_by_(i, acc_onlp_helper::Acc_Switch::Type));    
