...
function (install_aardvark)
    ...
    set(sdk_source_package_name "aardvark-api-linux-x86_64-v5.40.zip")
    ...
    if(NOT aardvark_api_zip)
        message(FATAL_ERROR "Error occurs when build project. Please provide and manually put Aardvark Software API (aardvark-api-linux-x86_64 v5.40) library to third_party directory.")
    endif()
    # This url requires login and password and cannot be used for automatic download, plase download this library manually.
    assure_package(aardvark-api-linux-x86_64 v5.40 "https://www.totalphase.com/products/aardvark-software-api/aardvark-api-linux-x86_64-v5.40.zip" "45219dc9d5c1259cd1773b39c57564d8")
