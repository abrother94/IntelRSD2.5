...
json::Json TransInfo::to_json() const {
    json::Json result;
...
TransInfo TransInfo::from_json(const json::Json& json) {
...
json::Json Onu_Trans_Rx_Pwr_Info::to_json() const {
    json::Json result;
...
Onu_Trans_Rx_Pwr_Info Onu_Trans_Rx_Pwr_Info::from_json(const json::Json& json) {
